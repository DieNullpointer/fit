...
namespace FitManager.Webapi.Controllers
{
    ...
    public class CompanyController : ControllerBase
    {
        ...
        public record RegisterDto(string name, string address, string country, string plz, string place, string billAddress, List<PartnerDto> partners, string package);
        ...
        public IActionResult Register([FromBody] RegisterDto register)
        {
            ...
            var company = new Company(register.name, register.address, register.country, register.plz, register.place, register.billAddress, package);
