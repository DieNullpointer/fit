...
namespace BeamerProtector.Webapp.Services
{
    ...
    public class AzureAdClient
    {
        ...
        public string LoginUrl => $"https://login.microsoftonline.com/{_tenantId}/oauth2/v2.0/authorize?client_id={_clientId}&response_type=code&redirect_uri={HttpUtility.UrlEncode(_redirectUrl)}&response_mode=query&scope=user.read offline_access mail.send";
