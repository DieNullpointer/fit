...
namespace BeamerProtector.Webapp.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public AccountController(AzureAdClient adClient, BeamerProtectorContext db, IConfiguration _config)
        {
            _adClient = adClient;
            _db = db;
            _key = Convert.FromBase64String(_config["Secret"] ?? throw new ApplicationException("Secret is not set."));
        }
